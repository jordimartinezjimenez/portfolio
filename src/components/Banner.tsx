        ...
        <section className="min-h-[100vh] container mx-auto flex flex-col justify-center items-center lg:justify-between lg:flex-row">
            <div className="flex flex-col justify-center items-center lg:justify-normal lg:items-baseline">
                ...
                <div className="flex gap-6 items-center mb-8">
                    <a href="#contact" className="flex items-center justify-center bg-gradient-to-r from-rose-500 to-pink-500 rounded-lg gap-2 py-1.5 px-8 cursor-pointer shadow-lg shadow-rose-500/50"><FaEnvelope color="white" />Contact</a>
                    <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-gradient-to-r from-rose-500 to-pink-500 rounded-lg gap-2 py-1.5 px-8 cursor-pointer shadow-lg shadow-rose-500/50"><FaCloudDownloadAlt color="white"  />Resume</a>
                </div>
