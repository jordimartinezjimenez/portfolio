        ...
        <section className="min-h-[100vh] container mx-auto flex flex-col justify-center items-center lg:justify-between lg:flex-row">
            <div className="flex flex-col justify-center items-center lg:justify-normal lg:items-baseline">
                ...
                <div className="flex gap-x-5 max-w-max mx-auto lg:mx-0">
                    <a href="https://www.linkedin.com/in/jordi-martinez-jimenez/" target="_blank" rel="noopener noreferrer" className="hover:scale-125 transition-transform duration-[400ms] ease banner-links1"><FaLinkedin color="#334155" size={35} /></a>
                    <a href="https://github.com/jordimartinezjimenez" target="_blank" rel="noopener noreferrer" className="hover:scale-125 transition-transform duration-[400ms] ease banner-links2"><FaGithub color="#334155" size={35} /> </a>
                    <a href="mailto:jordimj63@gmail.com" target="_blank" rel="noopener noreferrer" className="hover:scale-125 transition-transform duration-[400ms] ease banner-links3"><FaEnvelope color="#334155" size={35} /></a>
                    <button type="button" onClick={copyToClipboard} className="copy banner-links4">
